...
The code is provided in a CodeOcean capsule, located [here](https://codeocean.com/capsule/7737058/tree/v1), DOI: 10.24433/CO.3853882.v1.
...
[here](https://codeocean.com/capsule/7737058/tree/v1). Alternatively, the code can
be downloaded by
...
[here](https://codeocean.com/capsule/7737058/tree/v1), using the 'Reproducible Run'
button.
...
It is recommended that the code be run from the CodeOcean capsule, located
[here](https://codeocean.com/capsule/7737058/tree/v1). On the capsule page, click
