function results = KernelEmbeddingsRFF_impl(prob, sys, x0, u0, varargin)
% KERNELEMBEDDINGSRFF_IMPL Implementation of the KernelEmbeddingsRFF algorithm.
%
%   Requires SReachTools for the problem and system definittions.
%
%   Usage:
%
%       results = KERNELEMBEDDINGSRFF_IMPL(prob, sys, x0, u0)
%
%   Inputs:
%       prob    - Problem definition. This can be one of:
%                 srt.problems.TerminalHitting, srt.problems.FirstHitting,
%                 srt.problems.Viability.
%       sys     - System definition. KERNELEMBEDDINGSRFF_IMPL uses the
...
%
% See also: srt.algorithms.KernelEmbeddingsRFF
